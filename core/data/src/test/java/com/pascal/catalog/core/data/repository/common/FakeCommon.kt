package com.pascal.catalog.core.data.repository.common
...
class FakeApi(
    ...
    class FakeProductDao(initialProducts: List<ProductEntity>) : ProductDao {
...
fun entity(id: Int, title: String, isFavorite: Boolean) = ProductEntity(
    id = id,
    title = title,
    description = "Desc",
    category = "bags",
